...
<html>
<head>
	<title>Camagru login and signup</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="row">
		...
		<div class="col-sm-6" style="left:8%:">
			<img src="images/codingcafelogo.png" class="img-rounded" title="Camagru" width="80px" height="80px">
			<h2><strong>See what's happening in <br> the world right now</strong></h2><br><br>
			<h4><strong>Join Camagru Today.</strong></h4>
			<form method="post" action="">
				<button id="signup" class="btn btn-info btn-lg" name="signup">Sign up</button><br><br>
				<?php
					if(isset($_POST['signup'])){
						echo "<script>window.open('create-account.php','_self')</script>";
					}
				?>
